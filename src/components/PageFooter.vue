...
<template>
  <footer @click="logState" class="flex flex-none w-full bg-white-rgba border-t border-dark-elevation py-2 sticky top-[100vh] justify-center gap-4 backdrop-blur-xl">
    <a href="https://discord.gg/gAku95M5TB" target="_blank" rel="noopener noreferrer">
      <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="fab"
    ...
    <a href="https://github.com/AramidFinance" target="_blank" rel="noopener noreferrer">
      <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="fab"
    ...
    <a href="https://twitter.com/AramidFinance" target="_blank" rel="noopener noreferrer">
      <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="fab"
    ...
    <a href="https://www.linkedin.com/company/aramid-finance" target="_blank" rel="noopener noreferrer">
      <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="fab"
